...
三階職業的能力數值、技能與裝備限制均以 `PROJECT_SPEC.md` 為準。職業技能沿同一路線永久保留，每次轉職新增 2 個技能；玩家每場最多配置 3 個技能。進階職業可使用本路線前階裝備，並逐階增加專用武器與飾品類型。

御靈師第一階只使用靈狐襲與紙將衝陣；靈體只作為技能演出與傷害來源，不建立獨立戰鬥單位。四個第一階職業以同裝備等級下整體勝率接近為初版目標，但保留對不同敵人類型的相剋差異。

```text
進階職業內容關係
├─ 護法金剛：新增禪杖與護法系飾品；新增護法棍、伏魔震
├─ 鎮獄神將：新增戰戟與神將系飾品；新增鎮獄破、神將怒
├─ 流雲劍俠：新增長劍與劍俠系飾品；新增流雲十三式、雲蹤斬
├─ 凌霄劍仙：新增飛劍與劍仙系飾品；新增凌霄一劍、劍落九霄
├─ 通幽使：新增魂燈與通幽系飾品；新增幽冥鬼卒、攝魂靈獸
├─ 萬靈宗師：新增萬靈譜與宗師系飾品；新增萬靈朝宗、神將敕令
├─ 五行術士：新增拂塵與五行系飾品；新增五行烈焰、水雷法
└─ 乾坤天師：新增八卦鏡與天師系飾品；新增乾坤雷劫、天罡鎮煞
```
